...
RSpec.describe Coach, type: :model do
  ...
  context 'filtering data' do
    before do
      @con = FactoryBot.create_list(:coach, 3, country: 'Republic of Testing', show_in_directory: true)
      @cit = FactoryBot.create_list(:coach, 5, city: 'City of Testing', show_in_directory: true)
      @pos = FactoryBot.create_list(:coach, 4, postal_code: 'T35T1NG', show_in_directory: true)
      @c1 = FactoryBot.create(:coach, full_name: 'Ttester Number 1', show_in_directory: true)
      @c2 = FactoryBot.create(:coach, full_name: 'Ttester Number 2', show_in_directory: true)
      @c3 = FactoryBot.create(:coach, full_name: 'Ttester Number 3', show_in_directory: true)
      @c4 = FactoryBot.create(:coach, full_name: 'Ttester Number 4', show_in_directory: true)
    end
